...
$bio = $acRepo->getAccountFieldById($activeSessionUser, "bio");
                ...
                <div class="profile-personal-details-ctn">
                    <div class="prsn-details-flex-ctn">
                        <div class="name-username-ctn">
                            ...
                            <div class="username profile-card-username">
                                <?php echo ("@" . $acRepo->getAccountFieldById($activeSessionUser, "pseudonimi")) ?>
                            </div>
                        </div>
                        ...
                        <div class="birthdate-join-date-ctn">
                            ...
                            <div class="birthdate-ctn">
                                <span class="bday-txt username profile-card-username">
                                    <?php echo ($birthDate) ?>
                                </span>
                            </div>
                        ...
                        <div class="followers-following-ctn">
                            <div class="following-ctn follow-ctn">
                                <span class="follow-number following">
                ...
                <div class="feed-post">
                    ...
                    <div class="feed-post-content">
                        ...
                        if (count($tweetMedias) > 0) {
                            foreach ($tweetMedias as $tweetMedia) { ?>
                                <div class="picture-post-ctn">
                                    <img class="picture-post" src=<?php echo ($tweetMedia[0]) ?> alt="post pic example"></img>
                                </div>
                            <?php }
                        } ?>
                        <div class="post-interaction-ctn">
                            ...
                            <div class="like-post"> <span>
                                    <?php echo ($twRepo->getLikesForTweet($tweet["tweet_id"])) ?>
                                </span> <img src="images/like.svg" alt="like"></div>
