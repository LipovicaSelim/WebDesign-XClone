                    ...
                    <div class="feed-post-content">
                        <div class="feed-username-options">
                            <div class="username-name">
                                ...
                                <div>
                                    <a href='edit.php?id=<?php echo($tweet["perdoruesi_id"]) ?>'><img class="three-dots-op" src="images/threedots.svg" alt="options"></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="comment-post" style="width:100%">
                                <div class="input-tweet-ctn" style="width:100%">
                                    <div class="user-profile-pic">
                                        <img class="profile-pic" src=<?php echo ($acRepo->getProfilePicture((int)$activeUserId)[0]) ?> alt="">
                                    </div>
                                    <form action="<?php echo $formAction ; ?>" method="post" id="tweet-input-form">
                                        <input contenteditable type="text-area" name="tweet-new" id="tweet" placeholder="Post your reply" required>
                                        ...
                                        <div class="right-type">
                                            <button type="submit" name="post-comment" class="post-btn post-btn-feed" id="post-new-tweet" style="width:100px">Comment</button>
                                        </div>
                                    </form>
                                </div>
